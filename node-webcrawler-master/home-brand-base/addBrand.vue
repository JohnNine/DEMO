...
export default {
  ...
  methods: {
      ...
      if (
        ...
        if (this.brandInfo.listInfo.listed) {
          if (this.brandInfo.listInfo.listRecords.length <= 0) {
            ...
            this.brandInfo.listInfo.listRecords.forEach((val, index) => {
        ...
        if (this.brandInfo.honors.honored) {
          if (this.brandInfo.honors.honors.length <= 0) {
            ...
            // console.log(1,this.brandInfo.honors.honors)
            this.brandInfo.honors.honors.forEach((val, index) => {
              if (
                val.name &&
                val.org &&
                val.certificates.length > 0 &&
                val.date
              ) {
        ...
        if (this.brandInfo.mouthPieces.has) {
          if (this.brandInfo.mouthPieces.mouthPieces.length <= 0) {
            ...
            this.brandInfo.mouthPieces.mouthPieces.forEach((val, index) => {
        ...
        if (this.brandInfo.patents.has) {
          if (this.brandInfo.patents.agents.length <= 0) {
            ...
            this.brandInfo.patents.agents.forEach((val, index) => {
    ...
    removeImg2(ind, item) {
      let index = this.brandInfo.mouthPieces.mouthPieces[ind].photos.indexOf(
        item
      );
      if (index !== -1) {
    ...
    handleImagesUploaded2(data) {
      if (!this.brandInfo.mouthPieces.mouthPieces[data.key].photos) {
        this.$set(
          this.brandInfo.mouthPieces.mouthPieces[data.key],
          "photos",
          []
        );
      }
