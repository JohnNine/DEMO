<template>
        <div>
            <el-form ref="product" :model="product" label-width="80px">
                <el-form-item label="*产品分类:">
                    <el-select
                        ...
                        placeholder="请选择">
                        <el-option 
                            v-for="item in homeSPUCategories" 
                            :key="item.spuType" 
                            :label="item.spuTypeName" 
                            :value="item.spuType">
                        </el-option>
                    </el-select>
                    如需添加分类请联系销售在线提问
            ...
            <div class="img">
                <div>
                    ...
                    <div class="des">
                        图片至少上传3张，建议8张，最多20张。
                        <br>
                        图片740px < 宽度 < 1024px，高度 < 2048px，单张图片不要超过10M。
                    </div>
                </div>
            ...
            <div class="button">
                ...
                <el-button v-if='(productId = 0)' type="primary" @click="onSubmit('brandInfo')">审核不通过</el-button>
                <el-button v-if='(productId = 0)' type="primary" @click="onSubmit('brandInfo')">审核通过</el-button>
            </div>
