...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            getBackCategories () {
                service.invoke(service.ACTION_GET_BACKCATEGORIES, {}, data => {
                    console.log(data)
            ...
            getSelectedTags () {
                service.invoke(service.ACTION_GET_BRAND_TAGS, {}, data => {
                    if (data) {
                        console.log(data)
            ...
            getCategoryTags (item) {
                let data = { backCategoryId: item.categoryId, tagType: 0 }
                service.invoke(service.ACTION_GET_BACKCATEGORY_TAGS, data, (data) => {
                    item.tags = data.tags
